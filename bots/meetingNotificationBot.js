      ...
      if (context.activity.value == null) {
        ...
        if (context.activity.text.trim() == "SendTargetedNotification") {
          ...
          for (var member in meetingMembers.members) {
            ...
            console.log("members= ", meetingMembers); 
            ...
            if (participantDetail.meeting.inMeeting) {
              members.push({ id: participantDetail.user.id, name: participantDetail.user.name, aadObjectId: participantDetail.user.aadObjectId})
              //members.push(member);
            }
          }
